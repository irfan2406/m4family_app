...
class M4Type {
  ...
  static TextStyle get displayLarge =>
      serif(fontSize: 40, letterSpacing: -0.5, height: 1.08);
  static TextStyle get displayMedium => serif(
    fontSize: 32,
    letterSpacing: -0.5,
    height: 1.12,
  ); // OUR PHILOSOPHY / FEATURED PROPERTY
  static TextStyle get displaySmall =>
      serif(fontSize: 26, letterSpacing: -0.5, height: 1.16);
  static TextStyle get headlineSerif =>
      serif(fontSize: 22, letterSpacing: -0.3, height: 1.2); // card titles

  // --- SANS hierarchy (Montserrat) -------------------------------------------
  static TextStyle get headlineLarge => sans(
    fontSize: 24,
    fontWeight: FontWeight.w800,
    letterSpacing: -0.5,
    height: 1.2,
  );
  static TextStyle get headlineMedium => sans(
    fontSize: 20,
    fontWeight: FontWeight.w700,
    letterSpacing: -0.3,
    height: 1.25,
  );
  static TextStyle get titleLarge => sans(
    fontSize: 18,
    fontWeight: FontWeight.w700,
    letterSpacing: 0.15,
    height: 1.3,
  );
  static TextStyle get titleMedium => sans(
    fontSize: 16,
  ...
  static TextStyle get bodyLarge =>
      sans(fontSize: 16, fontWeight: FontWeight.w400, height: 1.5);
  static TextStyle get bodyMedium =>
      sans(fontSize: 14, fontWeight: FontWeight.w400, height: 1.5);
  static TextStyle get bodySmall =>
      sans(fontSize: 12, fontWeight: FontWeight.w400, height: 1.45);
  static TextStyle get labelLarge => sans(
    fontSize: 14,
    fontWeight: FontWeight.w600,
    letterSpacing: 1.1,
  ); // buttons
  static TextStyle get labelMedium => sans(
    fontSize: 12,
    fontWeight: FontWeight.w600,
    letterSpacing: 1.5,
  ); // uppercase pill labels
  static TextStyle get labelSmall => sans(
    fontSize: 10,
    fontWeight: FontWeight.w700,
    letterSpacing: 2.0,
  ); // tiny kickers
