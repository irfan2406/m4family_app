...
class SupportHandlers {
  ...
  static const String helpCenterUrl =
      'http://localhost:5008/support/help-center';

  static const String scheduleVisitUrl =
      'http://localhost:5008/booking/schedule-visit';
  static const String corporateAddress =
  ...
  static Future<void> launchWhatsApp([String? phone]) async {
    ...
    final Uri url = Uri.parse(
      'https://api.whatsapp.com/send?phone=${phone ?? whatsappNumber}',
    );
