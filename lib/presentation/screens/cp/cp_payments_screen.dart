  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Wallet & history',
          style: GoogleFonts.ebGaramond(fontWeight: FontWeight.w800, fontSize: 16),
        ),
      ),
      body: _loading
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            label.toUpperCase(),
            style: GoogleFonts.ebGaramond(fontSize: 9, letterSpacing: 1, color: Theme.of(context).hintColor),
          ),
          ...
          Text(
            ...
            style: GoogleFonts.ebGaramond(
              ...
              fontSize: 14,
              color: highlight ? Color(0xFFC5A35B) : null,
            ),
          ),
        ],
      ),
