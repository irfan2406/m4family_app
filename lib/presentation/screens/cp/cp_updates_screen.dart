  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('UPDATES', style: GoogleFonts.dmSerifDisplay(fontWeight: FontWeight.w900, letterSpacing: 2)),
      ),
      body: _loading
          ? Center(child: CircularProgressIndicator(color: accent))
          : _error != null
              ? Center(child: Text(_error!, style: GoogleFonts.dmSerifDisplay(color: scheme.onSurfaceVariant)))
              : RefreshIndicator(
                  onRefresh: _load,
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: GoogleFonts.dmSerifDisplay(fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 1.2),
                                        ),
                                      ),
