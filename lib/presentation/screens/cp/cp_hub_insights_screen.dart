  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Insights', style: GoogleFonts.dmSerifDisplay(fontWeight: FontWeight.w800)),
      ),
      body: _loading
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text('DAILY PULSE', style: GoogleFonts.dmSerifDisplay(fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 1.4, color: Colors.white)),
                      ),
                      const SizedBox(height: 10),
                      Text(
                        'Conversion rate $rate with $books bookings from $leads leads',
                        style: GoogleFonts.dmSerifDisplay(fontSize: 16, fontWeight: FontWeight.w900, color: Colors.white, height: 1.2),
                      ),
                      ...
                      FilledButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text('READ REPORT', style: GoogleFonts.dmSerifDisplay(fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2)),
                ...
                Row(
                  children: [
                    ...
                    Text('Latest Analysis', style: GoogleFonts.dmSerifDisplay(fontSize: 12, fontWeight: FontWeight.w900)),
                  ],
                ),
                const SizedBox(height: 12),
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.dmSerifDisplay(fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 1.3, color: const Color(0xFFA855F7)),
                      ),
                    ),
                  ),
                ],
          ...
          Text(
            title,
            style: GoogleFonts.dmSerifDisplay(fontSize: 13, fontWeight: FontWeight.w900, height: 1.2),
          ),
          const SizedBox(height: 4),
          Text(
            readTime.isEmpty ? 'READ' : readTime.toUpperCase(),
            style: GoogleFonts.dmSerifDisplay(fontSize: 9, fontWeight: FontWeight.w800, letterSpacing: 1.4, color: scheme.onSurface.withValues(alpha: 0.68)),
          ),
        ],
      ),
    );
