      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              'Payment History',
              style: GoogleFonts.ebGaramond(color: textPrimary, fontWeight: FontWeight.w800, fontSize: 16),
            ),
            Text(
              'FINANCIAL LEDGER',
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            value,
            style: GoogleFonts.ebGaramond(color: valueColor, fontSize: 14, fontWeight: FontWeight.w800),
          ),
        ],
      ),
    );
  ...
  Widget _buildSearch(bool isDark, Color textPrimary, Color muted, Color border) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: GoogleFonts.ebGaramond(color: muted, fontSize: 13, fontWeight: FontWeight.w500),
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: GoogleFonts.ebGaramond(color: textPrimary, fontSize: 12.5, fontWeight: FontWeight.w700),
                ),
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        ...
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: GoogleFonts.ebGaramond(color: muted, fontSize: 9, fontWeight: FontWeight.w600, letterSpacing: 0.5),
                      ),
                    ),
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.ebGaramond(color: statusColor, fontSize: 8, fontWeight: FontWeight.w800, letterSpacing: 0.5),
                ),
              ),
            ],
          ),
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.ebGaramond(color: textPrimary, fontSize: 13, fontWeight: FontWeight.w700),
          ),
          const SizedBox(height: 6),
          Text(
            'Your payment ledger is empty.',
            style: GoogleFonts.ebGaramond(color: muted, fontSize: 11, fontWeight: FontWeight.w500),
          ),
        ],
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.ebGaramond(color: textPrimary, fontSize: 14, fontWeight: FontWeight.w700),
            ),
            const SizedBox(height: 6),
            Text(
            ...
            ElevatedButton(
              ...
              child: Text('RETRY', style: GoogleFonts.ebGaramond(fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 1)),
            ),
          ],
        ),
      ),
