      ...
      children: [
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    const Icon(LucideIcons.sparkles, color: Colors.black, size: 28).animate(onPlay: (controller) => controller.repeat(reverse: true)).scaleXY(end: 1.2, duration: 1.seconds),
                  ],
                ),
        ...
        if (_jobs.isEmpty)
          const Padding(
            ...
            child: Center(
              child: Text('NO OPEN POSITIONS AT THE MOMENT.', style: TextStyle(color: Colors.white38, letterSpacing: 2, fontSize: 10, fontWeight: FontWeight.bold)),
            ),
          )
        else
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(LucideIcons.briefcase, color: Colors.white70, size: 28),
                    ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Icon(LucideIcons.mapPin, color: Colors.white.withOpacity(0.5), size: 12),
